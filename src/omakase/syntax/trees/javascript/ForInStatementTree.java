...
public class ForInStatementTree extends ParseTree {
  ...
  public ForInStatementTree(SourceRange location, ParseTree element, ParseTree collection, ParseTree body) {
    super(location, ParseTreeKind.JAVASCRIPT_FOR_IN_STATEMENT);
